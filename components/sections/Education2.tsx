										...
										<ul className="ps-3">
											<li className="position-relative z-1 mb-3">
												<div className="d-flex gap-2">
													...
													<div>
														<span className="text-primary-2">Bachelor of Computer Science</span>
														<p className="text-dark">Focused on Software Engineering and Core Programming</p>
													</div>
												</div>
											</li>
											<li className="position-relative z-1 mb-3">
												<div className="d-flex gap-2">
													...
													<div>
														<span className="text-primary-2">Advanced Next.js Certification</span>
														<p className="text-dark">Expertise in App Router, Server Components, and Performance Optimization</p>
													</div>
												</div>
											</li>
										</ul>
