													...
													<Marquee className="carouselTicker carouselTicker-left position-relative z-1">
														<ul className="carouselTicker__list m-0 ">
															...
															<li className="carouselTicker__item mt-6">
																...
																<span className="tool-tip">Neon DB</span>
															</li>
															<li className="carouselTicker__item mt-6">
																<Link href="#" className="brand-logo icon_80 icon-shape rounded-3">
																	<img src="assets/imgs/home-page-2/hero-1/icon-8.svg" alt="brand" />
																</Link>
																<span className="tool-tip">Clerk Auth</span>
															</li>
														</ul>
													</Marquee>
												</div>
														...
														<ul className="ps-3 d-flex flex-column justify-content-between h-100 position-relative">
															<li className="mb-3">
																<div className="d-flex flex-column flex-md-row gap-2">
																	...
																	<span className="text-300">Next.js (App Router), React, TypeScript, Tailwind CSS</span>
																</div>
															</li>
															<li className="mb-3">
																<div className="d-flex flex-column flex-md-row gap-2">
																	<p className="text-dark text-nowrap mb-0">Back-End:</p>
																	<span className="text-300">Node.js, Express, Prisma ORM</span>
																</div>
															</li>
															<li className="mb-3">
																<div className="d-flex flex-column flex-md-row gap-2">
																	<p className="text-dark text-nowrap mb-0">Databases:</p>
																	<span className="text-300">PostgreSQL (Neon), MongoDB</span>
																</div>
															</li>
															<li className="mb-3">
																<div className="d-flex flex-column flex-md-row gap-2">
																	<p className="text-dark text-nowrap mb-0">Tools &amp; Auth:</p>
																	<span className="text-300">Clerk Auth, Git, Vercel, Docker</span>
																</div>
															</li>
															<li className="mb-3">
																<div className="d-flex flex-column flex-md-row gap-2">
																	<p className="text-dark text-nowrap mb-0">Others:</p>
																	<span className="text-300">RESTful APIs, GraphQL, Serverless Architectures</span>
																</div>
															</li>
														</ul>
													</div>
